...
if(nama === "" && peran === ""){
    ...
    console.log("Halo "+ peran +" "+ nama +" , kamu dapat melihat siapa aja yang menjadi werewolf!");
}else if (nama === "Jenita" && peran === "Guard"){
    console.log("Selamat datang di Dunia Werewolf, "+ nama +"!");
    console.log("Halo "+ peran +" "+ nama +" , kamu dapat membantu temanmu dari serangan werewolf!");
